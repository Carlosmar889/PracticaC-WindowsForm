...
namespace ESFE.SysDesarrollo.LN
{
    ...
    {
        public const string _stringCnn = @"Data Source=LAPTOP-3GSMOK2P\SQLEXPRESS;Initial Catalog=BDDesarrollo;Integrated Security=True;TrustServerCertificate=True;
";
